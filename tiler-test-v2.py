...
if __name__ == '__main__':
    ...
    def get_data_from_sector(sector_tuple, sector_width, data, lons_ax, lats_ax, resolution, el_w):
        ...
        xxs = np.sign(xmin)
        xxi = int(math.floor(abs(xmin) * (el_w/resolution))*xxs)
    ...
    depth, extents, limits = get_data_from_sector(sector, 2.0, depths, depths_lons, depths_lats, 15, 60)
    print(limits)
    #stemps, extents = get_data_from_sector(sector, 2.0, temps, temps_lons, temps_lats, 4, 24)
